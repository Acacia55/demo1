          ...
          <div class="list">
            <div class="list-header">
              ...
              <div>
                ...
                <button type="button" class="btn btn-link" onclick="onSearchProject('${item.id}')">统计</button>
...
const onSearchProject = (pid) => {
  $util.setPageParam('seeProject', pid)
  location.href = "/pages/searchProject/index.html"
}